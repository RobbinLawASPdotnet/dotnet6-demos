...
namespace Model
{
	public class Person
	{
        ...
        private DateTime _dateOfBirth;    // Starting with Java, the recommended way to represent date-time information is via Temporal
        ...
        public Person()
        {
            _name = "Danielle Smith";
            _dateOfBirth = DateTime.Parse("1971-04-01");
        }
